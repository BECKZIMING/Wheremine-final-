...
public class SQLController {
	...
	//Executes 'SELECT' query in database with single field match capabilities
...
//			System.out.println("Searching for Item");
	...
	//Executes 'UPDATE' command in database with single field update capabilities
	...
	//Executes 'DELETE' command in database with exact matching of caller specified field
	...
	protected ResultSet getExpiredWarrantyAssets() {
		try {
			command = conn.createStatement();
			String query = "SELECT * FROM Assets WHERE WarrantyDate < "+ "date('now');";
			System.out.println(query);
	...
	protected ResultSet getAllAssetsByCategory(String category) {
		try {
			command = conn.createStatement();
			String query = "SELECT * FROM Assets WHERE Category = '" + category + "';";
			System.out.println(query);
			ResultSet res = command.executeQuery(query);
			return res;
		} catch(SQLException e) {
	...
	protected ResultSet getAllAssetsByLocation(String location) {
		try {
			command = conn.createStatement();
			String query = "SELECT * FROM Assets WHERE Location = '" + location + "';";
			System.out.println(query);
			ResultSet res = command.executeQuery(query);
			return res;
		} catch(SQLException e) {
