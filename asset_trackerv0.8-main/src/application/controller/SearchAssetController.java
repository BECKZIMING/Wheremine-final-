...
public class SearchAssetController {
	...
	//Searches for assets based on substring input, returns list of results in listview object
	...
	//cache selection and navigates to EditAsset.fxml page
	@FXML 
	...
	//Show confirmation window for asset deletion
	//pressing 'ok' button deletes asset from database
	//pressing 'cancel' button returns to current view with no changes
